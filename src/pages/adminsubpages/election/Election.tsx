  ...
  return (
    <div>
      ...
      <div className="election-page z-0 relative py-5">
        {/* PHASE I */}
        <div className="phase1 sticky top-0 md:static z-10 overflow-x-auto centered flex lg:gap-10 text-gray-700 dark:text-gray-400 pop-semibold text-xs md:text-sm lg:text:md bg-white dark:bg-[#303030] rounded-t-lg ">
