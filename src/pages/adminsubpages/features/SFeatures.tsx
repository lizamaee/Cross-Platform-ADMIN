      ...
      <div className="special-features-page py-5">
        ...
        <div className="phase1 flex lg:gap-10 text-gray-700 dark:text-gray-400 pop-semibold text-xs md:text-sm lg:text:md bg-white dark:bg-[#303030] rounded-t-lg ">
          <nav className='flex gap-5'>
            <button onClick={handleVoterTab} className={`election outline-none tracking-wide ml-3 py-3 ${voterTab ? `text-[#7a6ff0] dark:text-white border-b-2 border-[#7a6ff0]` : ``}`}>Voter</button>
            <button onClick={handleAdminTab} className={`organization outline-none tracking-wide py-3 ${adminTab ? `text-[#7a6ff0] dark:text-white border-b-2 border-[#7a6ff0]` : ``}`}>Admin</button>
          </nav>
        </div>
