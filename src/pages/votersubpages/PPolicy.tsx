...
export default function PPolicy() {
  ...
  return (
    <div className="dark:text-gray-300">
      <h1 className='text-[#1c295d] dark:text-gray-300 text-xl pt-1 md:pt-3 text-center pop-bold'>Privacy & Policy</h1>
      {/* NOTIFICATION HEADER */}
      ...
      <div className="privacy-policy pb-5 pt-7 px-5 mt-3 pop-regular text-justify centered max-h-[33rem] overflow-y-auto rounded-xl shadow-2xl bg-white dark:bg-[#313131]">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              this Agreement) refers to CICT VOTING SYSTEM.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to CICT VOTING SYSTEM, accessible
              from{" "}
              <a
                href="www.cictvoting.system"
                rel="external nofollow noopener"
                target="_blank"
              >
                www.cictvoting.system
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: menardpajares02@gmail.com</li>
        </ul>
      </div>
    </div>
  );
