...
export default function VSettings() {
  const { student_id, switchMode, isNight } = useAuthStore((state) => state);
  ...
  return (
    <div className="parent">
      <h1 className='text-[#1c295d] dark:text-gray-300 text-xl pt-1 md:pt-3 text-center pop-bold'>Settings</h1>
      {/* NOTIFICATION HEADER */}
              ...
              <div className="button flex justify-end">
                {isPasswordChanging ? (
                  <button
                    ...
                    className="bg-[#202142] text-sm dark:bg-[#33366d] text-white pop-medium focus:outline-none border-[1px] border-[#202142] rounded-lg flex py-2 px-3"
                  >
                    Saving password...
                  </button>
                ) : (
          ...
          <div className="delete pb-5 flex justify-between  border-t-2 border-dashed dark:border-zinc-700">
            ...
            {!isDeleteOpen ? (
              <button
                ...
                className="pop-regular text-sm underline text-red-500"
              >
                Show
              </button>
            ) : (
              ...
              <div className="button flex justify-end">
                {isPasswordResetting ? (
                  <button
                    ...
                    className="bg-[#202142] text-sm dark:bg-[#33366d] text-white pop-medium focus:outline-none border-[1px] border-[#202142] rounded-lg mt-4 flex py-2 px-3"
                  >
                    Saving password...
                  </button>
                ) : (
