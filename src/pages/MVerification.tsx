        ...
        <div className="otp">
          ...
          <div className="resend-wrapper text-sm flex justify-between pop-semibold  text-[#4C7CE5]">
            ...
            <Modal
              ...
              open={openModal}
              onOk={handleSubmit(handleChangeNumber)}
              confirmLoading={confirmLoading}
              onCancel={handleCancel}
              okText={"Confirm"}
              okButtonProps={countdown > 0 ? { disabled: true } : { disabled: false, style:{ color: '#d9d9d9' }, }}
            >
              ...
              {errors.mobile_number && <span className="text-red-400 text-center text-xs md:text-sm">{errors.mobile_number.message}</span>}
            </Modal>
            {!isResending 
              ? countdown > 0 
